...
The text content from the image is "Alec Radford".  
...
The text content from the image is "Karthik Narasimhan".  
...
$$
P ( y | x ^ { 1 } , \ldots , x ^ { m } ) = \operatorname { s o f t m a x } ( h _ { l } ^ { m } W _ { y } ) .
$$  

This gives us the following objective to maximize:  

$$
L _ { 2 } ( \mathcal { C } ) = \sum _ { ( x , y ) } \log P ( y | x ^ { 1 } , \ldots , x ^ { m } ) .
$$  

The text content from the image is "3 Framework".  
...
This will render the formula correctly in a LaTeX document.
$$  
...
The text content from the image is "4.1 Setup".  
...
"X. Zhang, and T. Ma. A simple but tough-to-beat baseline for sentence embeddings. 201"  
...
". Gray, A. Radford, and K. P. Diederik. Gpu kernels for block-sparse weights. 201"  

The text content from the image is:

"J. Ba, J. Kiros, and G. E. Hinton. Layer normalization. arXiv preprint arXiv:1607.06450, 2016"  
...
"Kitaev and D. Klein. Constituency parsing with a self-attentive encoder. ACL, 2018"  
...
[62] A. Vaswani, N. Shazeer, N. Parmar, J. Uszkoreit, L. Jones, A. N. Gomez, L. Kaiser, and I. Polosukhin. Attention is all you need. In Advances in Neural Information Processing Systems, pages 6000–6010, 2017.  
