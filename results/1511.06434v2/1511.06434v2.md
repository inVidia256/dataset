...
The core of our approach involves adopting and modifying three recently demonstrated changes to CNN architectures.  
...
The suggested value of 0.9 resulted in training oscillation and instability while reducing it to 0.5 helped stabilize training.  

The text content from the image is "4.1.1 DEDUPLICATION".  

4.2 FACES  

The text content from the image is "4.1 LSUN".  
...
The text content from the image is "4.3 IMAGENET-1K".  
...
Ting and Visualizing the Internals of the Network  
...
1: Generations of a DCGAN that was trained on the Imagenet-1k dataset  
