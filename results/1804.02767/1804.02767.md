...
The text content from the image is "2.1. Bounding Box Prediction".  
...
The text content from the image is "2.2. Class Prediction".  

The text content from the image is "2.4. Feature Extractor".  

2.3. Predictions Across Scales  

The text in the image reads "Table 1. Darknet-53."  
...
[18] O. Russakovsky, L.-J. Li, and L. Fei-Fei. Best of both worlds: human-machine collaboration for object annotation. In Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition, pages 2121–2131, 2015.

[19] M. Scott. Smart camera gimbal bot scanlime:027, Dec 2017.

[20] A. Shrivastava, R. Sukthankar, J. Malik, and A. Gupta. Beyond skip connections: Top-down modulation for object detection. arXiv preprint arXiv:1612.06851, 2016.

[21] C. Szegedy, S. Ioffe, V. Vanhoucke, and A. A. Alemi. Inception-v4, inception-resnet and the impact of residual connections on learning. 2017.  
